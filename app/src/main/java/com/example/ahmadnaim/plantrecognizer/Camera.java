...
public class Camera extends Fragment {
    ...
    private Button txtAnswerCamera;
    private ImageView imgAnswerCamera;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FragmentActivity camera = super.getActivity();
        RelativeLayout relative    = (RelativeLayout)    inflater.inflate(R.layout.fragment_camera, container, false);

        txtAnswerCamera = (Button) relative.findViewById(R.id.txtAnswerCamera);
        imgAnswerCamera = (ImageView) relative.findViewById(R.id.imgAnswerCamera);
        txtAnswerCamera.setOnClickListener(onClickImage);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent imageReturnedIntent) {
        ...
        try
        {
            ...
            imgAnswerCamera.setImageBitmap(bmpAnswer);
            txtAnswerCamera.setText(String.format("This is a %s", recognize(imgTest)));
        }
